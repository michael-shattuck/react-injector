...
var injectClass = function injectClass(subject, dependencyHierarchy) {
    if (hasDependencies(subject)) {
        var declareDependencies = subject.declareDependencies || subject.prototype.declareDependencies;
        var dependencies = resolveDependencies(declareDependencies(), dependencyHierarchy || [subject]);
