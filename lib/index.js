...
exports.ReactInjector = exports.Container = exports.InjectDirect = exports.Inject = undefined;

var _Inject2 = require('./Inject');

Object.defineProperty(exports, 'InjectDirect', {
  enumerable: true,
  get: function get() {
    return _Inject2.InjectDirect;
  }
});
